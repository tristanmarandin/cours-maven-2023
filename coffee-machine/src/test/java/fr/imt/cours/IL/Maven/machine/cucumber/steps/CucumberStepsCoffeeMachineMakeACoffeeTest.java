...
public class CucumberStepsCoffeeMachineMakeACoffeeTest {
    ...
    @Then("the coffee machine should be correctly connected to the electrical network")
    public void theCoffeeMachineShouldBeCorrectlyConnectedToTheElectricalNetwork() {
