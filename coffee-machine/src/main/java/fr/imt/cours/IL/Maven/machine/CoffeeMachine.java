...
import fr.imt.cours.IL.Maven.machine.component.*;
import fr.imt.cours.IL.Maven.machine.exception.CannotMakeCremaWithSimpleCoffeeMachine;
...
import fr.imt.cours.IL.Maven.storage.cupboard.container.*;
...
public class CoffeeMachine {
    ...
    public void addWaterInTank(double waterVolume){
        if (waterVolume < 0) {
            throw new IllegalArgumentException("Cannot add a negative amount of water");
        }
    ...
    public void addCoffeeInBeanTank(double coffeeVolume, CoffeeType coffeeType){
        if (coffeeVolume < 0) {
            throw new IllegalArgumentException("Cannot add a negative amount of coffee");
        }
        this.beanTank.increaseCoffeeVolumeInTank(coffeeVolume, coffeeType);
    }
