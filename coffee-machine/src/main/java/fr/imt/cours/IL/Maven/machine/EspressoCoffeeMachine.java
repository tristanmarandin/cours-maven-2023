...
import fr.imt.cours.IL.Maven.machine.component.SteamPipe;
...
public class EspressoCoffeeMachine extends CoffeeMachine{
    ...
    public void addCoffeeInSecondaryBeanTank(double coffeeVolume, CoffeeType coffeeType){
        if (coffeeVolume < 0) {
            throw new IllegalArgumentException("Cannot add a negative amount of coffee");
        }
        this.secondaryBeanTank.increaseCoffeeVolumeInTank(coffeeVolume, coffeeType);
    }
}
